/* VoiceManager.h
*  Header file for declaring instance variables for setting various parameters 
* of the modules for a Voice.
* @author: Jon Patman | CS 360
*/
#ifndef __Metamorpho__VoiceManager__
#define __Metamorpho__VoiceManager__
...
private:
	static const int NumberOfVoices = 32;
