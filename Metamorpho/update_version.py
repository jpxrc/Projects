...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright JPatman, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Metamorpho-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Metamorpho-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Metamorpho-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Metamorpho-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Metamorpho-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Metamorpho-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Metamorpho-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Metamorpho.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Metamorpho.iss",inplace=1):
