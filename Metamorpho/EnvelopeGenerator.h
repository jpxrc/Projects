/* Envelope Generator.h
*  Header file responsible for constructing an Envelope Generator and it's parameters
* @author: Jon Patman | CS 360
*/

#ifndef __Metamorpho__EnvelopeGenerator__
#define __Metamorpho__EnvelopeGenerator__

#include <cmath>
#include "GallantSignal.h"
using Gallant::Signal0; // Signal and slots style implementation
