...
* Class responsible for handling the different "states" of the Envelope Generator.
* @author: Jon Patman | CS 360
*/

#include "EnvelopeGenerator.h"

// Sets the generator to the sample rate.
...
// Calculates the value that is multiplied to the current sample
...
// Responsible for resetting the envelope generator
...
// Sets the values of the variables for each stage
